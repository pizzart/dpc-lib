...
use crate::walle_fmt::common::{HasReferences, ObjectZ, PascalArray, WALLEObjectFormat};
...
pub type SkinObjectFormat = WALLEObjectFormat<ObjectZ, SkinZ>;
pub type SkinObjectFormatAlt = WALLEObjectFormat<ObjectZ, SkinZAlt>;
