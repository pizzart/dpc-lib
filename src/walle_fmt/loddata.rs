...
use crate::walle_fmt::common::{
    write_option, FixedVec, HasReferences, PascalArray, ResourceObjectZ, WALLEObjectFormat,
};
...
pub type LodDataObjectFormat = WALLEObjectFormat<ResourceObjectZ, LodDataZ>;
