...
use crate::walle_fmt::common::{
    FixedVec, HasReferences, PascalArray, ResourceObjectZ, Vec3i32, WALLEObjectFormat,
};
...
pub type AnimationObjectFormat = WALLEObjectFormat<ResourceObjectZ, AnimationZ>;
